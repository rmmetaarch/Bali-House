...
const baliHouse = new Entity('baliHouse')
engine.addEntity(baliHouse)
baliHouse.setParent(_scene)
const transform5 = new Transform({
  position: new Vector3(16, 0, 16),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
baliHouse.addComponentOrReplace(transform5)
const gltfShape3 = new GLTFShape("ea72a27b-c939-4683-8812-56a94dfc2d87/Bali House.glb")
gltfShape3.withCollisions = true
gltfShape3.isPointerBlocker = true
gltfShape3.visible = true
baliHouse.addComponentOrReplace(gltfShape3)
